...
const validationSchema = Yup.object().shape({
  ...
  difficulty: Yup.string().is(["easy", "medium", "hard"]).required().label("Difficulty"),
...
export default function CreateExerciseForm(
  ...
  return (
    <View style={{ flex: 1 }}>
      <Formik validationSchema={validationSchema} onSubmit={createExercise} initialValues={initialValues}>
        {(formik) => (
          <>
            <View style={{ flex: 1 }}>
              <ValidatedInput
            ...
            <Button
              ...
              type={!(formik.isValid && formik.dirty) ? "outlined" : "contained"}
              color="primary"
            >
              Save and Share
            </Button>
