...
const CREATE_EXERCISE_MUTATION = gql`
  mutation CreateExercise($title: String!, $description: String!, $difficulty: String!, $muscleGroup: String!, $equipment: String!) {
    createExercise(
      input: { title: $title, description: $description, difficulty: $difficulty, muscleGroup: $muscleGroup, equipment: $equipment }
    ) {
      exerciseId
      title
      description
