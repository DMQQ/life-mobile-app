...
const colorPalettes: ColorPalette[] = [
    ...
    },
    {
        ...
        primary_lighter: "#2C2C2E",
        primary_surface: "#242426",
        primary_lightest: "#3A3A3C",
        primary_faded: "#48484A",
        primary_dark: "#000000",
        primary_darker: "#000000",
        secondary_light_1: "#409CFF",
        secondary_light_2: "#6AB0FF",
        secondary_dark_1: "#0060DF",
        secondary_dark_2: "#003DA6",
        warning: "#FF9F0A",
        success: "#30D158",
        danger: "#FF453A",
        info: "#64D2FF",
        positive: "#30D158",
        negative: "#FF453A",
        chart_positive: "#34C759",
        text_light: "#FFFFFF",
        text_dark: "#8E8E93",
        overlay: "rgba(0,0,0,0.6)",
        foreground_secondary: "rgba(235,235,245,0.6)",
        foreground_disabled: "rgba(235,235,245,0.3)",
        foreground_hairline: "rgba(84,84,88,0.6)",
        ternary_light_1: "#5E5CE6",
        ternary_light_2: "#BF5AF2",
        borderColor: "#38383A",
    },
    {
        name: "Ash Slate",
