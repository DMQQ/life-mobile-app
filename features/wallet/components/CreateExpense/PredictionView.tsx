...
const styles = StyleSheet.create({
    ...
    aiLabel: {
        position: "absolute",
        top: -5,
        left: (Layout.screen.width - 30) / 1.4 / 2 - 50,
        ...
        <AnimatedPressable
            ...
            style={[
                pulseStyle,
                {
                    ...
                    position: "absolute",
                    top: 15,
                    left: (Layout.screen.width - (Layout.screen.width - 30) / 1.4) / 2,
                },
            ]}
        >
            <Animated.View
                style={[
                    styles.aiLabel,
                    {
                        backgroundColor: Color(iconBackgroundColor).darken(0.25).hex(),
                        borderColor: Color(iconBackgroundColor).alpha(0.25).hex(),
                    },
                ]}
            ...
            >
                ...
                >
                    <LinearGradient
                        colors={[
                            Color(iconBackgroundColor).darken(0.5).hex(),
                            Color(iconBackgroundColor).darken(0.25).hex(),
                            iconBackgroundColor,
                        ]}
                        start={{ x: 0, y: 0 }}
                        end={{ x: 1, y: 1 }}
                ...
                <TouchableOpacity activeOpacity={0.9} style={{ zIndex: 1000, flex: 1 }} onPress={item.applyPrediction}>
                    <GlassView
                        style={[
                            {
                                borderRadius: 20,
                    ...
                    >
                        ...
                        <View style={{ height: "100%", justifyContent: "center", flex: 3 }}>
                            <Text
                                style={[
                                    styles.title,
                                    { textShadowColor: "rgba(255, 255, 255, 0.3)", textShadowRadius: 2 },
                                ]}
                                numberOfLines={1}
                            >
                                {item.description}
