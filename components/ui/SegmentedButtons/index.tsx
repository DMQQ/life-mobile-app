...
export default function SegmentedButtons(props: SegmentedButtonsProps) {
    ...
    if (props.value === undefined) throw new Error("SegmentedButtons: value is undefined")
                    ...
                    style={[
                        {
                            ...
                            borderRadius: 10,
                            backgroundColor: props.value === value.value ? Colors.secondary : Colors.primary_light,
                        },
                        props.buttonStyle,
                    ]}
                >
