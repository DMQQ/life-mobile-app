    ...
    <Ripple onLongPress={onLongPress} onPress={onPress} style={[timelineStyles.itemContainer, timeline.styles]}>
      <View style={{ flex: 1 }}>
        <View style={[timelineStyles.itemContainerTitleRow]}>
          <Text numberOfLines={1} style={[timelineStyles.itemTitle, { ...(timeline.textColor && { color: timeline.textColor }) }]}>
            {timeline.title}
          </Text>
        ...
        >
          <Text
            numberOfLines={3}
            style={[timelineStyles.itemDescription, { flex: 1 }, { ...(timeline.textColor && { color: timeline.textColor }) }]}
          >
